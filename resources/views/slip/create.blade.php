      ...
      <div class="form-group" >
        <div>
            <select class="form-control" name="type" id="">
               <option value="livraison" selected>Livraison-BL</option> 
               <option value="vente">Vente-BV</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group" id="A14">
        <div>
            <select class="form-control" name="destinataire" id="">
               <option value="" selected>Destinataire</option>
               @foreach($warehouse as $key=>$ware)
               <option value="{{$key+1}}">{{$ware->name}}</option>
               @endforeach
            </select>
        </div>
    </div>
